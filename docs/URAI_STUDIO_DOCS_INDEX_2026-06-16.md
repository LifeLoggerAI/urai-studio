...
This index points to the current repo-side documents and machine-readable contract files that describe the Studio app, integrations, health surface, export handoff, and remaining verification work.
...
- `apps/studio/tests/spatial-handoff-openapi.test.mjs` — supplemental OpenAPI regression test.
