...
export const createStudioTenant = functions.https.onCall(async (data, context) => {
  ...
  return db.runTransaction(async (transaction) => {
    ...
    if (priorRequest.exists) return priorRequest.data()?.result;
    ...
    transaction.create(requestRef, { actorUid, action: "create_studio_tenant", requestId, result, createdAt: now });
    return result;
  });
});
...
export const manageStudioMembership = functions.https.onCall(async (data, context) => {
  ...
  return db.runTransaction(async (transaction) => {
    ...
    transaction.create(requestRef, { actorUid, studioId, action: "manage_studio_membership", requestId, result, createdAt: now });
    return result;
  });
});
...
export const transferStudioOwnership = functions.https.onCall(async (data, context) => {
  ...
  return db.runTransaction(async (transaction) => {
    ...
    transaction.create(requestRef, { actorUid, studioId, action: "transfer_studio_ownership", requestId, result, createdAt: now });
    return result;
  });
});
