...
assert.ok(source.includes('digital_human_likeness_must_start_unapproved'));
assert.ok(source.includes('digital_human_voice_must_start_unapproved'));
assert.ok(source.includes('digital_human_performance_must_start_uncertified'));
assert.ok(source.includes('digital_human_provider_execution_must_start_off'));
assert.ok(source.includes('digital_human_public_release_must_start_off'));
