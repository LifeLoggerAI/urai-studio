export type SystemStatus = 'Observed healthy' | 'Evidence required' | 'Demo' | 'Prototype' | 'Internal' | 'Planned';
...
export const systems: SystemDef[] = [
  { id: 'studio', name: 'URAI Studio', slug: 'studio', status: 'Evidence required', description: 'Cinematic life interface and creative control surface.', capabilities: ['module orchestration', 'life map storytelling'], dependencies: ['privacy', 'admin', 'asset-factory', 'spatial'], route: '/studio', cta: 'Explore Studio', visibility: 'public', versionLane: 'v1', relatedModule: 'studio' },
  ...
  { id: 'visuals', name: 'URAI Visuals', slug: 'visuals', status: 'Evidence required', description: 'Symbolic visual system, sky layers, and export packs.', capabilities: ['brand lattice', 'asset exports'], dependencies: ['studio', 'asset-factory'], route: '/visuals', cta: 'View Visuals', visibility: 'public', versionLane: 'v1', relatedModule: 'visuals' },
  { id: 'spatial', name: 'URAI Spatial', slug: 'spatial', status: 'Evidence required', description: 'Public spatial route spine and memory-world launch surface.', capabilities: ['public route spine', 'static export', 'live route smoke'], dependencies: ['studio', 'privacy', 'asset-factory'], route: '/spatial', cta: 'View Spatial', visibility: 'public', versionLane: 'v1', relatedModule: 'spatial' },
  { id: 'privacy', name: 'URAI Privacy', slug: 'privacy', status: 'Evidence required', description: 'Private by design controls and consent tiers.', capabilities: ['consent controls', 'export/delete posture'], dependencies: [], route: '/privacy', cta: 'Read Privacy', visibility: 'public', versionLane: 'v1', relatedModule: 'privacy' },
  ...
  { id: 'labs', name: 'URAI Labs LLC', slug: 'labs', status: 'Evidence required', description: 'Company and product stewardship.', capabilities: ['product stewardship'], dependencies: ['studio'], route: '/contact', cta: 'Contact URAI Labs', visibility: 'public', versionLane: 'v1', relatedModule: 'labs' },
];
